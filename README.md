Конечно! Добавлю примеры использования для каждой функции задач в README.md.
...
Эти примеры использования помогут пользователям понять, как работать с каждой функцией бота.
